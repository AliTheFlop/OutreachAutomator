                        ...
                        <div className="max-h-32 overflow-y-auto border border-gray-300 rounded-lg p-3">
                            ...
                            {contacts.map((contact) => (
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        checked={newCampaign.contactIds.includes(
                                            contact.id
                                        )}
                                        onChange={(e) => {
                                            if (e.target.checked) {
                    ...
                    <div className="flex items-center gap-2 mt-6">
                        <button
                            ...
                            disabled={
                                ...
                                newCampaign.contactIds.length === 0
                            }
